...
mixin _$PostDto {
 ...
 String get id; String get userId; String get content; String? get contentJson; String get visibility; int get likeCount; int get commentCount; int get shareCount; int get viewCount; int get repostCount; int get quoteCount; int get mentionCount; String get language; String get difficulty; List<String> get topics; bool get isReported; bool get isPinned; bool get isFeatured; String? get inReplyToPostId; String? get inReplyToUserId; String? get repostOfId; String? get quoteOfId; ReferencedPostDto? get inReplyToPost; ReferencedPostDto? get repostOf; ReferencedPostDto? get quoteOf; DateTime? get deletedAt; DateTime? get bookmarkedAt; DateTime get createdAt; DateTime get updatedAt; PostUserDto get user; List<HashtagDto> get hashtags; List<MentionDto> get mentions; List<MediaDto> get media;
