...
mixin _$PostDto {
 ...
 String get id; String get userId; String get content; String? get contentJson; String get visibility; int get likeCount; int get commentCount; int get shareCount; int get viewCount; int get repostCount; int get quoteCount; int get mentionCount; String get language; String get difficulty; List<String> get topics; bool get isReported; bool get isPinned; bool get isFeatured; String? get inReplyToPostId; String? get inReplyToUserId; String? get repostOfId; String? get quoteOfId; ReferencedPostDto? get inReplyToPost; ReferencedPostDto? get repostOf; ReferencedPostDto? get quoteOf; DateTime? get deletedAt; DateTime? get bookmarkedAt; DateTime get createdAt; DateTime get updatedAt; PostUserDto get user; List<HashtagDto> get hashtags; List<MentionDto> get mentions;
...
@useResult
$Res call({
 String id, String userId, String content, String? contentJson, String visibility, int likeCount, int commentCount, int shareCount, int viewCount, int repostCount, int quoteCount, int mentionCount, String language, String difficulty, List<String> topics, bool isReported, bool isPinned, bool isFeatured, String? inReplyToPostId, String? inReplyToUserId, String? repostOfId, String? quoteOfId, ReferencedPostDto? inReplyToPost, ReferencedPostDto? repostOf, ReferencedPostDto? quoteOf, DateTime? deletedAt, DateTime? bookmarkedAt, DateTime createdAt, DateTime updatedAt, PostUserDto user, List<HashtagDto> hashtags, List<MentionDto> mentions
});
...
class _PostDto extends PostDto {
  const _PostDto({required this.id, required this.userId, required this.content, this.contentJson, required this.visibility, required this.likeCount, required this.commentCount, required this.shareCount, required this.viewCount, required this.repostCount, required this.quoteCount, required this.mentionCount, required this.language, required this.difficulty, required final  List<String> topics, required this.isReported, required this.isPinned, required this.isFeatured, this.inReplyToPostId, this.inReplyToUserId, this.repostOfId, this.quoteOfId, this.inReplyToPost, this.repostOf, this.quoteOf, this.deletedAt, this.bookmarkedAt, required this.createdAt, required this.updatedAt, required this.user, required final  List<HashtagDto> hashtags, required final  List<MentionDto> mentions}): _topics = topics,_hashtags = hashtags,_mentions = mentions,super._();
