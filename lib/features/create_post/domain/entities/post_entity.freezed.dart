...
mixin _$PostEntity {
 ...
 String get id; String get userId; String get content; String? get contentJson; String get visibility; int get likeCount; int get commentCount; int get shareCount; int get viewCount; int get repostCount; int get quoteCount; int get mentionCount; String get language; String get difficulty; List<String> get topics; bool get isReported; bool get isPinned; bool get isFeatured; String? get inReplyToPostId; String? get inReplyToUserId; String? get repostOfId; String? get quoteOfId; DateTime? get deletedAt; DateTime get createdAt; DateTime get updatedAt; PostUserEntity get user; List<HashtagEntity> get hashtags; List<MentionEntity> get mentions;
...
class _PostEntity implements PostEntity {
  const _PostEntity({required this.id, required this.userId, required this.content, this.contentJson, required this.visibility, required this.likeCount, required this.commentCount, required this.shareCount, required this.viewCount, required this.repostCount, required this.quoteCount, required this.mentionCount, required this.language, required this.difficulty, required final  List<String> topics, required this.isReported, required this.isPinned, required this.isFeatured, this.inReplyToPostId, this.inReplyToUserId, this.repostOfId, this.quoteOfId, this.deletedAt, required this.createdAt, required this.updatedAt, required this.user, required final  List<HashtagEntity> hashtags, required final  List<MentionEntity> mentions}): _topics = topics,_hashtags = hashtags,_mentions = mentions;
